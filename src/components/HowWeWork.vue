<template>
    <div class="bg-orange-100 grid  grid-cols-1 md:grid-cols-2 px-6 md:px-10 lg:px-20 py-20 xl:px-28 gap-20 justify-center items-center">
      <div>
        <article>
      ...
      <div>
            <div class="flex gap-6 items-center">
                <h1 class="text-6xl font-900">1</h1>
                <h3>Full service range including</h3>
            </div>
            <div class="flex  items-center gap-6 my-6">
                <h1 class="text-6xl font-900">2</h1>
                <h3>Technical skills, design, business</h3>
            </div>
            <div class="flex items-center gap-6">
                <h1 class="text-6xl font-900">3</h1>
                <h3>Themselves in the merchant's</h3>
            </div>
      </div>
    </div>
  </template>
